...
>
> **Measured over the current table (⟦PENDING-REBUILD⟧ — a distributional measurement over the contiguous range, so it moves with the rebuild):** t = 2 (20.4%), 3 (46.1%), 4 (18.0%), 5 (10.1%), 6 (4.0%), with a tail to 10; mean 3.36, and **t ≤ 4 covers 84.5%**, t ≤ 5 covers 94.6%.
>
