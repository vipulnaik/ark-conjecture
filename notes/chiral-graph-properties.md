...
> **And it predicts where the interesting examples live — but n = 5 is settled, from another direction.** n = 5 is the smallest prime power where the factor is paid, and it is where the chiral analysis found a candidate: the down-closure of one A₅-orbit of Hamiltonian cycles is ℚ-acyclic with H̃₁ = ℤ/2, homotopy equivalent to ℝP² (see `pending-checks.md` R10).
>
