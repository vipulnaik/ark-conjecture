...
- **By theorem:** the bound is ≤ n·log₂n, so sharing is excluded wherever δ(n)·C(n,2) > n·log₂n — from **n ≥ 371** at the ladder's δ ≥ 0.04621, overlapping the table, and beyond 10⁶ under δ(n) ≫ log n/n, the weakest hypothesis yet used anywhere.
