...
>
> **At n ≡ 11 (mod 12), F = 4 wins**: the two F = 2 options both land on r ≡ 1 (mod 4), so with the ℓ = 3 obstruction the best F = 2 can reach is η = 1/6 and cap₂(1/6) = 0.050510 < 7 − 4√3. The D = 24 obstruction is a property of F = 2 in that class.
>
