...
| 7, 15 | **⟦EG-TENTATIVE⟧** F = 2 entangled | S7 at F = 2, full twist | 1/2 | (2−√2)/... x* per cap₂ | — | **1/8** | 0.12500 (was F = 4 at 1/9 = 0.11111: freeing c mod 4 reaches r ≡ 5 (mod 8), v = 2, η = 1/2, and cap₂(1/2) = 1/8 > 1/9; re-derive x* and the interval on rebuild) |
...
| class (mod 24) | family, efficiency | cap | attained at x\* | x-window | width |
|---|---|---|---|---|---|
...
| 3, 19 | S7 at F = 2, η = 1/2 | 0.12500 | 0.2500 | [0.237, 0.263] | 0.026 |
| 5, 17 | S7 at F = 2, η = 1/3 | 0.10102 | 0.2247 | [0.213, 0.239] | 0.026 |
| 7, 15 | **⟦EG-TENTATIVE⟧** S7 at F = 2 entangled, η = 1/2 | 0.12500 | — | re-measure | — |
...
| S4 | **wins nowhere**; the argmax of the three-part family at 7, 15, 23 mod 24, where F = 4 beats the family | §3.2 |
| **S7 at F = 2** | carries odd n — **8/24**, the residues 1, 3, 5, 9, 13, 17, 19, 21 mod 24 | §3.2 |
| **S7 at F = 4** | carries odd n — **4/24**, the residues 7, 11, 15, 23 mod 24 | §3.3.5 |
