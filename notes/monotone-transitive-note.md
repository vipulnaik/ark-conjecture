...
*Added 2026-09, from a question of Vipul's. It is the first example in this note of a natural monotone property, invariant under a transitive group, that is settled at **every** finite group — including the ones the Oliver criterion cannot touch.*
