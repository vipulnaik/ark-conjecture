...
**Demonstration worth keeping:** run Theorem 2 with ℛ = S_D itself. Then qr ≫ n²/D reaches Ω(n²) on the r-side and the min is still pinned at p²k ≈ n^{1+γ} by the companion — feeding in the endpoint hypothesis buys nothing, which localises all of (H)'s difficulty in the companion clause rather than in S_D's thinness.
