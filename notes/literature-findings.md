...
2. **The quadratic optimisation as a load-bearing step.** cap_F(η) = η/(1 + √(Fη))² and its balance points produce the seven mod-24 ceilings; they are not decoration. Behrend's radius optimisation is the nearest analogue, but it optimises a *construction* rather than a ceiling on all constructions.
