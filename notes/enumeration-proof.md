...
| **S5** | fused matching + outside; forces q = 2 | enumerated | v2 **58** (3.0%); v3 **21.8%**, inflated by the same artefact; v4 pending | 3.6 → 3.9 → **1.6%** | **carries odd n jointly with S4** at c ≡ 3, 7 (mod 8) | cap₂(η) = 0.17157 at η = 1, but η = 1 needs a **Fermat** prime; at η = 1/3 it is 0.10102, already below S4's 1/9. Max seen 0.1614 (n = 639) |
